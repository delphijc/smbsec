...
<critical>The workflow execution engine is governed by: core-tasks-workflow.md</critical>
<critical>You MUST have already loaded and processed: design-thinking-workflow.md</critical>
<critical>Load and understand design methods from: design_methods.csv</critical>
